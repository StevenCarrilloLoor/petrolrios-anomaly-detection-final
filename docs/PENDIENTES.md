...
- [~] 🟠 UX de alertas (mejora #2, **HECHO `e5d7bdb`**): ✅ buscador por placa/RUC/nº factura/cliente/código (backend `?buscar=` + caja con rebote), ✅ nº de factura y placa/cliente como **enlaces** a la bandeja filtrada, ✅ **abrir en ventana nueva**, ✅ botón **copiar**. ⏳ Pendiente: "ver todas las **facturas** del cliente" (reporte sobre datos de origen) y despachador→despachos+imprimir.
