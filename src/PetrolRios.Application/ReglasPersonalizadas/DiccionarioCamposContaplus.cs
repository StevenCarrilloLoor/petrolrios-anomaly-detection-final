...
public static class DiccionarioCamposContaplus
{
    ...
    private static readonly IReadOnlyDictionary<string, (string Etiqueta, RolCampo Rol, string Desc)> Glosario =
        new Dictionary<string, (string, RolCampo, string)>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["IMP_DCTO"] = ("Importe del documento ($)", RolCampo.Monto, "Importe del documento."),
            ["SER_DCTO"] = ("Serie del documento", RolCampo.Codigo, "Serie/establecimiento del comprobante."),
            ["GUI_DCTO"] = ("Número de guía", RolCampo.Numero, "Guía de remisión asociada."),
            ["ORD_DCTO"] = ("Número de orden", RolCampo.Numero, "Orden asociada al documento."),
            ["DIR_DCTO"] = ("Dirección", RolCampo.Texto, "Dirección del cliente en el documento."),
            ["COD_ACTI"] = ("Código de actividad", RolCampo.Codigo, "Actividad económica."),
            ["COD_BODE"] = ("Código de bodega", RolCampo.Codigo, "Bodega o almacén."),
            ["COD_GRUP"] = ("Código de grupo", RolCampo.Codigo, "Grupo del documento o cliente."),
            ["COD_XUSUA"] = ("Usuario que registró", RolCampo.Codigo, "Usuario que creó el documento."),
            ["NUMMCOMP"] = ("Número de comprobante", RolCampo.Numero, "Número del comprobante."),
            ["NUM_VAUC"] = ("Número de voucher", RolCampo.Numero, "Voucher de pago con tarjeta."),
            ["NUM_LIQV"] = ("Número de liquidación", RolCampo.Numero, "Liquidación asociada."),
            ["NUM_TICK_MOV"] = ("Número de ticket", RolCampo.Numero, "Ticket del movimiento."),
            ["FEC_XDCTO"] = ("Fecha de modificación", RolCampo.Fecha, "Última modificación del documento."),
            ["NIP_XDCTO"] = ("Usuario de modificación", RolCampo.Codigo, "Usuario que modificó el documento."),
    ...
    [
        ...
        ("AUT", RolCampo.Codigo, "Autorización."),
        ("GUI", RolCampo.Numero, "Guía."),
        ("ORD", RolCampo.Numero, "Orden."),
        ("LIQ", RolCampo.Numero, "Liquidación."),
        ("VAU", RolCampo.Numero, "Voucher."),
        ("SER", RolCampo.Codigo, "Serie."),
