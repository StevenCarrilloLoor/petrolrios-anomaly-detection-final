...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    if (!token) return;
    // La identidad, el rol y la estación se resuelven exclusivamente desde los claims
    // firmados del JWT; la query string ya no participa en la autorización del hub.
