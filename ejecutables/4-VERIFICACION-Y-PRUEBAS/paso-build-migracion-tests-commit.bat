@echo off
REM ============================================================
REM  PASO COMPLETO EN UNO: build Release + (migracion EF opcional)
REM  + tests + commit con tu identidad. Plantilla manual: edita las
REM  2 variables de abajo por cada cambio y ejecutalo.
REM ============================================================
...
set "MIGRACION="
set "MENSAJE=Describe aqui el cambio de este paso"
