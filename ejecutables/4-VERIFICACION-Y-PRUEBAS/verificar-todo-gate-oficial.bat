@echo off
REM ============================================================
REM  GATE OFICIAL DE VERIFICACION (usar antes de cada commit)
REM  Detiene servicios, compila en Release, corre TODAS las pruebas,
REM  comprueba que el modelo EF no tenga migraciones pendientes, y
REM  hace lint + build del frontend. Si algo falla, se detiene.
REM ============================================================
setlocal
cd /d "%~dp0..\.."
