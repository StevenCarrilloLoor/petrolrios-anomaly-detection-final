...
REM INSTALA EL MONITOR COMO SERVICIO (WINDOWS)
REM Registra PetrolRios.StationMonitor.exe como servicio de Windows. Ejecutar como Administrador en la carpeta del monitor.
REM ============================================================
setlocal
cd /d "%~dp0"
