...
copy /Y "ejecutables\5-PUBLICACION-Y-DESPLIEGUE\agente-LEEME-windows.txt" "dist\agente-windows\LEEME.txt" > nul
copy /Y "ejecutables\5-PUBLICACION-Y-DESPLIEGUE\instalar-agente-como-servicio-windows.bat" "dist\agente-windows\instalar_agente_servicio.bat" > nul
...
if errorlevel 1 goto fin_error
copy /Y "ejecutables\5-PUBLICACION-Y-DESPLIEGUE\agente-LEEME-linux.txt" "dist\agente-linux\LEEME.txt" > nul
copy /Y "ejecutables\5-PUBLICACION-Y-DESPLIEGUE\instalar-agente-como-servicio-linux.sh" "dist\agente-linux\instalar_agente_servicio.sh" > nul
...
if errorlevel 1 goto fin_error
copy /Y "ejecutables\5-PUBLICACION-Y-DESPLIEGUE\agente-LEEME-macos.txt" "dist\agente-macos-intel\LEEME.txt" > nul
copy /Y "ejecutables\5-PUBLICACION-Y-DESPLIEGUE\instalar-agente-como-servicio-macos.sh" "dist\agente-macos-intel\instalar_agente_servicio_macos.sh" > nul
...
if errorlevel 1 goto fin_error
copy /Y "ejecutables\5-PUBLICACION-Y-DESPLIEGUE\agente-LEEME-macos.txt" "dist\agente-macos-arm\LEEME.txt" > nul
